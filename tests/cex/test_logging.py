...
from src.cex import config
from src.cex.observability.logging_setup import setup_logging, emit_perf, file_name, _HANDLER_TAG
...
def test_emit_perf_noop_without_setup():
    ...
    import src.cex.observability.logging_setup as ls
    ls._PERF = None
