...
from src.cex.config import get_stream_key, get_active_symbols_key, get_inactive_symbols_key
from src.cex.core.connector import Book, coerce_levels
from src.cex.plugins.binance import BinanceSpotConnector
...
def test_monitor_evicts_only_after_consecutive_absence():
    from src.cex.config import MONITORING
...
def test_supervisor_discovers_binance():
    from src.cex.supervisor import _discover
