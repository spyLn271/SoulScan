...
from src.cex.core.jsonio import dumps, loads, HAVE_ORJSON
...
def test_metrics_record_and_graceful_server():
    from src.cex.observability import metrics as m
...
def test_settings_typed_and_validated():
    from src.cex.settings import CexV2Settings
    s = CexV2Settings()
...
def test_coerce_levels_drops_non_finite():
    from src.cex.core.connector import coerce_levels
...
def test_manager_cleans_handler_on_crash(monkeypatch):
    from src.cex.market_data import manager as M
    closed = []
