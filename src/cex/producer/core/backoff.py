#!/usr/bin/env python3
"""Unified exponential-backoff-with-jitter helper shared by the plugin-restart
wrapper, the supervisor respawn, and the stream-watcher reconnect. Pure
next_delay() core + sync/async sleep wrappers."""
import random
import time
import asyncio
