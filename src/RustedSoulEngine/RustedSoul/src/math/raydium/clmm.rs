...
Raydium's CLMM is actually Uniswap V3, but with small changes.
Raydium has only Static, static fee fully behaves like Uniswap V3.
...
(P.S Raydium uses Q64.64 precision)
