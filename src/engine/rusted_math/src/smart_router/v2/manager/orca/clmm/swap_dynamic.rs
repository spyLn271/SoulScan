...
use crate::smart_router::v2::manager::orca::clmm::fee_dynamic::*;
...
pub fn swap_manager(
    ...
    timestamp: u64,
    whirlpool: &Whirlpool
) -> Result<DynamicOrcaResult, SoulManagerError> {
    let mut result = DynamicOrcaResult {
        total_amount_in: 0,
        total_amount_out: 0,
        total_fee_amount: 0,
        crossed_tick_groups: 0,
        new_sqrt_price: 0,
        new_liquidity: 0
    };
    ...
    let mut crossed_tick_groups: u16 = whirlpool.base_info.crossed_tick_groups;
    ...
    result.new_sqrt_price = current_sqrt_price;
    result.crossed_tick_groups = crossed_tick_groups;
