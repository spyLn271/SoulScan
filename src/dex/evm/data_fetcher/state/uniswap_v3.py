...
async def uniswap_v3_slot_fetcher(network: Network):
    ...
    setup_logger(
        log_file=f"{get_config().DATA_FETCHER_LOG_FOLDER}/uniswap_v3_{network}_fetcher.log",
...
class UniswapV3StateFetcher(FetcherSkeleton):
    def __init__(self):
        setup_logger(
            log_file=f"{get_config().DATA_FETCHER_LOG_FOLDER}/uniswap_v3_state_fetcher.log",
